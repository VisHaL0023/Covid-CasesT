...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView todayRecovered, totalDeath, todayDeath,totalTests, dateTV ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cname.setOnClickListener(v ->
                startActivity(new Intent(MainActivity.this, CountryActiivity.class)));
                    ...
                    public void onResponse(Call<List<CountryData>> call, Response<List<CountryData>> response) {
                        ...
                        for(int i=0; i<list.size(); i++){
                            if(list.get(i).getCountry().equals(country)){
                                ...
                                todayDeath.setText(NumberFormat.getInstance().format(death));
